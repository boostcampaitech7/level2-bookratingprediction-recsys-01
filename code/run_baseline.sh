...
python main.py  -c config/config_baseline.yaml  -m NFM  -w True  -r NFM_baseline
python main.py  -c config/config_baseline.yaml  -m NFFM  -w True  -r NFFM_baseline
python main.py  -c config/config_baseline.yaml  -m DeepFFM  -w True  -r DeepFFM_baseline
